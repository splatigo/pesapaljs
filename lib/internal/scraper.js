...
var PesaPalScraper = function (method, html, debug) {
    ...
    var getPaymentParameters = function () {
        ...
        if(method.tag == "MPESA" || method.tag == "ZAP" ||method.tag=="ZAP_UG" ||method.tag=="MTNMONEY_UG") { // mobile
            ...
            params.TransactionPaymentMethod = method._internalTag; // HUH: CREDITCARD or CREDITCARDMC
